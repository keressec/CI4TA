...
{
    // Fungsi Construct : fungsi yang pertama kali dipanggil ketika projek tersebut pertama kali diinisialisasi
    ...
    public function delete2($id = null)
    {
        ...
        return redirect()->to(site_url('groups/sampah'))->with('success', 'Data Berhasil Dihapus Permanen');
        }else {
            $this->model->purgeDeleted();
            return redirect()->to(site_url('groups/sampah'))->with('success', 'Semua Data Berhasil Dihapus Permanen');
        }
